...
// LCD的数据手册也有提供，可以知道显示屏为320*240，
// LCD_DisplayStringLine这个函数根据参数可知，
// 是按行来显示的，显示屏共有Lin0~Lin9，每行可以显示20个字符。
#define Line0          0
#define Line1          24
#define Line2          48
#define Line3          72
...
/*----- High layer function -----*/
/*
这个LCD显示字符是按行显示的，总共可以显示10行字符（Line0~Line9），并且每一行可以显示20个字符

那么这个方法就面临了一个问题，如果我想显示一个数字变量，那可怎么办

以指定的字符串格式存入数组中，然后再调用显示函数把数组里的元素显示出来
*/
...
void LCD_DisplayChar(u8 Line, u16 Column, u8 Ascii);    //任何位置显示单个字符
